...
<head profile="<?php print $grddl_profile; ?>">
  ...
  <?php print $styles; ?>
  <?php print $scripts; ?> 
  <link rel="stylesheet" href="/sites/all/themes/sitemade/css/style.css?ver=1.1" type="text/css" media="screen" />
  <link rel="stylesheet" href="/sites/all/themes/sitemade/css/nivo-slider.css" type="text/css" media="screen" />
     <?php print $scripts; ?>
  <script type="text/javascript" src="/sites/all/themes/sitemade/js/jquery-1.10.2.js"></script>
  <script type="text/javascript" src="/sites/all/themes/sitemade/js/jquery.nivo.slider.js"></script>
  <link href='http://fonts.googleapis.com/css?family=Open+Sans:600,400&subset=cyrillic,cyrillic-ext,latin,latin-ext' rel='stylesheet' type='text/css'>
</head>
...
(function(){ var widget_id = 'CpTtr8AuQM';
